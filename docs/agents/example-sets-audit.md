...
That updates the section between `<!-- BEGIN:instance-validation -->
...
(none)
<!-- END:instance-validation -->` in this file, and writes JSON to `/opt/cursor/artifacts/example-instance-audit.json`.
