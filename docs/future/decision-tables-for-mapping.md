...
| **Java** | Yes — helper | `generateJava` emits `decisionTable(...)` / `sheetLookup(...)` next to Archie RM construction (same helper-or-flatten choice as TypeScript). Not executed in web app Test Run. |
