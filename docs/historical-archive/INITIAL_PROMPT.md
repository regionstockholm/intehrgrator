...
For a concise overview of the openEHR data model and key concepts, see [docs/OPENEHR_PRIMER.md](../OPENEHR_PRIMER.md).
...
Using the foundational blocks from Step 1, we will construct the rest of the application's logic and user interface. For the detailed split-screen layout, interaction design, and environment abstraction, see [docs/UI_ARCHITECTURE.md](../UI_ARCHITECTURE.md).
* **Split-Screen UI:** 
...
| Document | Contents |
|----------|----------|
| [docs/OPENEHR_PRIMER.md](../OPENEHR_PRIMER.md) | openEHR data model overview |
| [docs/UI_ARCHITECTURE.md](../UI_ARCHITECTURE.md) | UI layout, panes, interactions, v1 scope (authoritative over early wireframes) |
| [docs/BLOCKLY_INTEGRATION.md](../BLOCKLY_INTEGRATION.md) | Blockly blocks and code generation |
| [docs/MAPPING_SPECIFICATION.md](../MAPPING_SPECIFICATION.md) | Center-pane DSL (not export code) |
| [docs/SOURCE_FORMATS.md](../SOURCE_FORMATS.md) | JSON/XML schema and example instances |
| [docs/SOURCE_QUERY.md](../SOURCE_QUERY.md) | fontoxpath source querying |
| [docs/PROJECT_PERSISTENCE.md](../PROJECT_PERSISTENCE.md) | Project Bundle and Mapping Model |
| [docs/AI_SUGGESTION_FORMAT.md](../AI_SUGGESTION_FORMAT.md) | Copy-paste AI assist response format |
| [docs/assets/prototype-ui-v1-consolidated.png](../assets/prototype-ui-v1-consolidated.png) | Consolidated v1 UI mockup |
| [docs/future/](../future/) | Deferred features |
