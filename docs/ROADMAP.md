...
- [ ] **Human multi-user collaboration** (late): live co-editing, CRDT/sync — Chunk 14; architecture prep in [`docs/design/ARCHITECTURE-multi-user-collab-prep.md`](design/ARCHITECTURE-multi-user-collab-prep.md)
