...
function openEhrTypeToolboxContents(m: ReturnType<typeof msg>): Array<Record<string, unknown>> {
  return [
    {
      kind: "category",
      name: m.CAT_OPENEHR_ENTRIES,
      colour: 230,
      cssconfig: { row: "blocklyToolboxCategory blocklyToolboxCategoryOpenEhrEntries" },
      contents: [
        ...
        { kind: "block", type: "activity", gap: 8 },
        { kind: "block", type: "participation", gap: 8 },
        { kind: "block", type: "feeder_audit", gap: 8 },
        { kind: "block", type: "feeder_audit_details", gap: 8 },
        { kind: "block", type: "link", gap: 8 },
        { kind: "block", type: "ism_transition", gap: 8 },
        { kind: "block", type: "archetyped", gap: 8 },
      ],
    },
    {
      kind: "category",
      name: m.CAT_OPENEHR_ITEMS,
      colour: 230,
      cssconfig: { row: "blocklyToolboxCategory blocklyToolboxCategoryOpenEhrItems" },
      contents: [
        { kind: "block", type: "cluster", gap: 8 },
        { kind: "block", type: "element", gap: 8 },
        { kind: "block", type: "event", gap: 8 },
        { kind: "block", type: "point_event", gap: 8 },
        { kind: "block", type: "interval_event", gap: 8 },
        { kind: "block", type: "item_structure", gap: 8 },
        { kind: "block", type: "item_tree", gap: 8 },
        { kind: "block", type: "item_list", gap: 8 },
        { kind: "block", type: "item_table", gap: 8 },
        { kind: "block", type: "item_single", gap: 8 },
      ],
    },
    {
      kind: "category",
      name: m.CAT_OPENEHR_PARTY,
      colour: 230,
      cssconfig: { row: "blocklyToolboxCategory blocklyToolboxCategoryOpenEhrParty" },
      contents: [
    ...
    {
      kind: "category",
      name: m.CAT_OPENEHR_DV,
      colour: 230,
      cssconfig: { row: "blocklyToolboxCategory blocklyToolboxCategoryOpenEhrDv" },
      contents: dataValueToolboxContents(),
    },
    {
      kind: "category",
      name: m.CAT_OPENEHR_TERMS,
      colour: 230,
      cssconfig: { row: "blocklyToolboxCategory blocklyToolboxCategoryOpenEhrTerms" },
      contents: [
  ...
  return {
    ...
    contents: [
      ...
      },
      {
        ...
        contents: openEhrTypeToolboxContents(m),
      },
